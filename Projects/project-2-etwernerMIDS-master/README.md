...
In this repo, you will find a number of files:

* README.md - Repository overview (this file).
* Project2.md - Outlined process for migrating data events through Kafka, Spark, and into Hadoop.
* docker-compose.yml - File definition for running multi-container Docker applications.
* assessment-attempts-20180128-121051-nested.json - JSON data file for this project.
* etwernerMIDS-history.txt - Text file including all command line history.
* my_spark_history.txt - Text file including all Spark environment command line history.
